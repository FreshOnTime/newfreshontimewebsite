  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
        <div>
          <p className="text-sm font-semibold uppercase tracking-[0.16em] text-emerald-700">Partnership pipeline</p>
          <h1 className="mt-2 text-3xl font-bold text-gray-900">Supplier & partnership applications</h1>
          <p className="mt-2 text-gray-600">Applications from growers, makers, distributors, business buyers, and strategic partners.</p>
        </div>
      ...
      {loading ? (
        ...
        <Card><CardContent className="py-16 text-center text-zinc-500">No partnership applications in this view yet.</CardContent></Card>
      ) : (
          ...
          {filteredLeads.map((lead) => (
            <Card key={lead._id}>
              <CardHeader className="pb-3">
                <div className="flex items-start justify-between gap-4">
                  <div className="flex items-start gap-3">
                    <div className="rounded-full bg-emerald-50 p-2.5 text-emerald-700"><Handshake className="h-5 w-5" /></div>
                    <div>
              ...
              <CardContent className="space-y-4">
                ...
                {lead.requirement && <p className="whitespace-pre-line rounded-lg bg-zinc-50 p-4 text-sm leading-relaxed text-zinc-600">{lead.requirement}</p>}
