...
export default function LuxuryManifesto() {
  return (
    <section className="bg-[#f3efe6] px-4 py-24 text-[#142019] md:py-36">
      <div className="container mx-auto max-w-7xl">
        <div className="mx-auto max-w-5xl text-center">
          <span className="text-[10px] font-bold uppercase tracking-[0.36em] text-[#8b6d32]">The FreshPick philosophy</span>
        ...
        <div className="mt-20 grid border-y border-[#142019]/15 md:grid-cols-3">
          {principles.map((principle, index) => (
            <article key={principle.number} className={`px-2 py-10 md:px-10 md:py-12 ${index > 0 ? "border-t border-[#142019]/15 md:border-l md:border-t-0" : ""}`}>
              <span className="font-serif text-sm italic text-[#a07e3e]">{principle.number}</span>
