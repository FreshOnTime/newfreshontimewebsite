        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {banners.map((b) => (
            <Link key={b.title} href={b.href} className="group relative h-[400px] overflow-hidden bg-zinc-900 transition-all duration-700">
              ...
              <div className="absolute inset-0 p-10 flex flex-col justify-end items-start border-[0.5px] border-white/10 group-hover:border-emerald-300/60 transition-colors duration-700 m-4">
                <p className="text-[10px] font-bold tracking-[0.3em] uppercase mb-4 text-emerald-300 transform translate-y-4 opacity-0 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-500 delay-100">
                  {b.sub}
                </p>
                ...
                <span className="inline-flex items-center text-xs font-bold tracking-widest uppercase text-white/90 border-b border-white/40 pb-1 group-hover:border-emerald-300 transition-all">
                  Shop Now
                </span>
              </div>
            </Link>
