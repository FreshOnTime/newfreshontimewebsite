...
import { ArrowRight, Compass, MapPin, ShoppingBasket, Sparkles } from "lucide-react";

const quickLinks = [
    { label: "Discover", href: "/discover" },
    { label: "Dinner tonight", href: "/meal-kits" },
            ...
            <div className="container relative z-10 mx-auto max-w-[1600px] px-5 pb-8 pt-32 md:px-10 md:pb-12 lg:px-16 lg:pb-16">
                <div className="grid items-end gap-12 xl:grid-cols-[minmax(0,1fr)_360px]">
                    <div className="animate-fade-up">
                        <div className="mb-7 flex flex-wrap items-center gap-3">
                            <span className="inline-flex items-center gap-2 rounded-full border border-white/[0.15] bg-white/10 px-4 py-2 text-[10px] font-bold uppercase tracking-[0.25em] text-emerald-100 backdrop-blur-md">
                                <Sparkles className="h-3.5 w-3.5" /> Food discovery, curated in Colombo
                            </span>
                        ...
                        <h1 className="max-w-6xl text-balance font-serif text-[3.55rem] font-normal leading-[0.9] tracking-[-0.045em] text-white sm:text-7xl md:text-8xl lg:text-[7.15rem]">
                        ...
                        <div className="mt-8 grid max-w-6xl gap-7 lg:grid-cols-[minmax(0,650px)_auto] lg:items-end">
                            <p className="max-w-2xl text-base font-light leading-7 text-white/[0.72] md:text-lg md:leading-8">
                                Start with dinner, a craving, a local discovery, or the weekly routine. FreshPick connects the moment to groceries, meal kits, ready meals, and independent Sri Lankan makers.
                            </p>
                    ...
                    <aside className="hidden rounded-[2rem] border border-white/[0.12] bg-white/[0.08] p-7 backdrop-blur-xl xl:block">
                        <span className="text-[9px] font-bold uppercase tracking-[0.26em] text-emerald-200">A different kind of food shop</span>
                        <p className="mt-5 font-serif text-3xl font-normal leading-tight text-white">Discovery before aisles. Taste before transactions.</p>
                        <div className="mt-7 space-y-4 border-t border-white/[0.12] pt-6 text-sm font-light text-white/65">
                            <div className="flex items-center justify-between gap-4"><span>Meal-led discovery</span><span className="text-white">Explore</span></div>
