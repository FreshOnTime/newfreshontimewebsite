...
export default function HeroSection() {
    return (
        <section className="relative flex min-h-[94vh] items-end overflow-hidden bg-[#09090b] text-white">
            <div className="absolute inset-0 z-0">
                <Image
                    ...
                    unoptimized
                />
                <div className="absolute inset-0 bg-gradient-to-r from-[#09090b]/95 via-[#09090b]/60 to-black/15" />
                <div className="absolute inset-0 bg-gradient-to-t from-[#09090b] via-transparent to-black/45" />
            ...
            <div className="container relative z-10 mx-auto px-5 pb-16 md:px-10 md:pb-20 lg:px-16 lg:pb-24">
                <div className="grid items-end gap-12 lg:grid-cols-[1fr_300px]">
                    <div className="animate-fade-up">
                        <span className="mb-8 inline-flex items-center gap-3 text-[10px] font-bold uppercase tracking-[0.36em] text-[#6ee7b7]">
                            <span className="h-px w-10 bg-[#6ee7b7]/70" /> Colombo · Est. 2024
                        </span>
                        <h1 className="max-w-5xl font-serif text-6xl font-normal leading-[0.86] tracking-[-0.04em] text-[#ffffff] md:text-8xl lg:text-[7.8rem]">
                        ...
                        <div className="mt-10 flex flex-col gap-8 md:flex-row md:items-end">
                            ...
                            <div className="flex flex-wrap gap-3">
                                <Link prefetch={false} href="/products" className="group inline-flex h-14 items-center gap-3 bg-[#ffffff] px-7 text-[11px] font-bold uppercase tracking-[0.18em] text-[#09090b] transition-colors hover:bg-white">
                                    Enter the collection <ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-1" />
                                </Link>
                                <Link prefetch={false} href="/subscriptions" className="inline-flex h-14 items-center border border-white/25 px-7 text-[11px] font-bold uppercase tracking-[0.18em] text-white transition-colors hover:border-[#6ee7b7] hover:text-[#d1fae5]">
                                    Weekly curation
                                </Link>
                            </div>
                        </div>
                    ...
                    <aside className="hidden border-l border-white/15 pl-8 lg:block">
                        <ArrowDownRight className="h-5 w-5 text-[#6ee7b7]" />
